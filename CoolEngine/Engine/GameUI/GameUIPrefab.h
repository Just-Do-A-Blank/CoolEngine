...
#define FOLDERLOCATIONUIPREFAB "//Resources//UIPrefabs"

class GameUIPrefab : public GameObject
{
public:
    GameUIPrefab();
    GameUIPrefab(GameUIPrefab const& other);
    GameUIPrefab(string identifier, CoolUUID uuid);
    GameUIPrefab(const nlohmann::json& data, CoolUUID uuid);

    virtual ~GameUIPrefab()override;
